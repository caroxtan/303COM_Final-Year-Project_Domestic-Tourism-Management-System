				...
				if (isset($_POST['submitted'])) {
				   ...
				   if (empty($username)) {
					...
					//if repeated password does not match initial password
						...
						{
							mysqli_query($store, "UPDATE user set password='" . $_POST["password"] . "' WHERE username='" . $_POST["username"] . "'");
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Forget Password</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Forget Password</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form method="post"  action="forgetPassword.php">
							...
							<div class="form-row">
                                <div class="control-group col-sm-11">
                                    <input type="password" class="form-control p-4" id="password" name="password" value= "<?php if(isset($_POST["password"])) echo $_POST["password"]; ?>" placeholder="New Password" />
                                </div>
