...
<div class="w3-main" style="margin-top:43px;">
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
	  ...
	  <center><i class='fa fa-star' style='font-size:16px; color: #ffe338;'></i> 5<hr>
	  <i class='fa fa-star' style='font-size:16px; color: #ffe338;'></i> 4<hr>
...
<?php
	...
	$query = mysqli_query($store, "SELECT review.review_id, review.place_id, user.username AS username, review.review_datetime AS review_datetime, review.review_rating AS review_rating, review.review_type AS review_type, review.review_description AS review_description, review. review_picture AS review_picture FROM review LEFT OUTER JOIN user ON review.user_id=user.user_id WHERE review.place_id =  '{$place_id}' AND review.review_rating = 4 ORDER BY review.review_datetime DESC ");
